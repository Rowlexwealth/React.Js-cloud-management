...
import {
    CloudUploadIcon, DatabaseIcon,
    PaperAirplaneIcon, ServerIcon
} from '@heroicons/react/solid'

import bgImg from '../assets/person-2.jpg'
    ...
    <div name='home' className='w-full h-screen bg-zinc-200 flex flex-col justify-between'>
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            <div className='flex flex-col justify-center md:items-start w-full px-2 py-8'>
                ...
                <button className='py-3 my-4 px-6 sm:w-[40%]'>Get Started</button>
            </div>
            <div>
                <img className='w-full rounded-[15px]' src={bgImg} alt="/" />
            </div>
            <div className='absolute flex flex-col py-8 md:min-w-[760px] bottom-[-7%] mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl'>
